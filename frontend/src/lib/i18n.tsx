...
const T: Record<string, Entry> = {
  ...
  jyo_tithi: { en: "Tithi", te: "తిథి", hi: "तिथि" },
  jyo_nakshatra: { en: "Nakshatra", te: "నక్షత్రం", hi: "नक्षत्र" },
  jyo_tarabala: { en: "Tarabala", te: "తారాబలం", hi: "ताराबल" },
  jyo_new_ventures: { en: "New ventures", te: "కొత్త పనులు", hi: "नए कार्य" },
  jyo_continuations: { en: "Continuations", te: "కొనసాగింపులు", hi: "जारी कार्य" },
  ...
  nav_admin: { en: "Admin", te: "అడ్మిన్", hi: "एडमिन" },
  ...
  admin_joined: { en: "Joined", te: "చేరిన తేదీ", hi: "शामिल हुए" },
  admin_refresh: { en: "Refresh", te: "రిఫ్రెష్", hi: "रिफ़्रेश" },
  admin_status_approved: { en: "approved", te: "ఆమోదించబడింది", hi: "स्वीकृत" },
  admin_status_pending: { en: "pending", te: "పెండింగ్", hi: "लंबित" },
  admin_status_rejected: { en: "rejected", te: "తిరస్కరించబడింది", hi: "अस्वीकृत" },
  admin_denied_title: { en: "Access denied", te: "ప్రవేశం నిరాకరించబడింది", hi: "पहुँच अस्वीकृत" },
  admin_denied_body: { en: "This page is for the administrator only.", te: "ఈ పేజీ కేవలం నిర్వాహకుడి కోసం మాత్రమే.", hi: "यह पृष्ठ केवल प्रशासक के लिए है।" },
  approval_pending_title: { en: "Awaiting approval", te: "ఆమోదం కోసం వేచి ఉంది", hi: "स्वीकृति की प्रतीक्षा में" },
  approval_pending_body: { en: "Your account is awaiting administrator approval. You'll be able to generate your jaathakam once it's approved.", te: "మీ ఖాతా నిర్వాహకుడి ఆమోదం కోసం వేచి ఉంది. ఆమోదం లభించిన వెంటనే మీరు మీ జాతకాన్ని రూపొందించవచ్చు.", hi: "आपका खाता प्रशासक की स्वीकृति की प्रतीक्षा में है। स्वीकृत होते ही आप अपना जातक बना सकेंगे।" },
  approval_rejected_body: { en: "Your account request was not approved. Please contact the administrator.", te: "మీ ఖాతా అభ్యర్థన ఆమోదించబడలేదు. దయచేసి నిర్వాహకుడిని సంప్రదించండి.", hi: "आपका खाता अनुरोध स्वीकृत नहीं हुआ। कृपया प्रशासक से संपर्क करें।" },
